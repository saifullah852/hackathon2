...
<section className="text-gray-600 body-font">
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">ONLINE GRAPHIC T-SHIRT.
        
      </h1>
      <p className="mb-8 leading-relaxed">Graphic t-shirt is perfect for any occasion.Crafted from a soft and breathable fabric it offers superior comfort and style.</p>
      <div className="flex justify-center">
        <button className="inline-flex text-white bg-black border-0 py-5 px-20 focus:outline-none rounded text-lg">Add To Cart</button>
        
      </div>
    </div>
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img className="object-cover object-center rounded" alt="hero" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6cmeqhGJwttO0SStE0NebwzKcbeRUi4FdTg&s"/>
    </div>
  </div>
  <div>
    ...
    <div>
      <p className="text-center justify-center font-extrabold py-6 pd-6 text-3xl">All Reviews</p>
    </div>
    <section className="text-gray-600 body-font">
    ...
    <div className="flex flex-wrap -m-4 text-center">
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-900">Kashif T.</h2>
          <p className="leading-relaxed">"I'm blown away by the quality and style of the clothes I received from shop.co from casual wear elegant dresses every piece i'v bought have exceeded my expectations." </p>
        </div>
      </div>
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-900">Adnan L.</h2>
          <p className="leading-relaxed">"I'm blown away by the quality and style of the clothes I received from shop.co from casual wear elegant dresses every piece i'v bought have exceeded my expectations."</p>
        </div>
      </div>
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-900">Abdullah J.</h2>
          <p className="leading-relaxed">"I'm blown away by the quality and style of the clothes I received from shop.co from casual wear elegant dresses every piece i'v bought have exceeded my expectations."</p>
        </div>
      </div>
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-900">Jamal L.</h2>
          <p className="leading-relaxed">"I'm blown away by the quality and style of the clothes I received from shop.co from casual wear elegant dresses every piece i'v bought have exceeded my expectations."</p>
        </div>
      </div>
    </div>
...
<button
          type="button"
          className="bg-indigo-900 text-white text-sm font-semibold py-3 px-8 rounded-full shadow-lg hover:bg-blue-500"
        >
          Load More Reviews
        </button>
        </div>
        <section className="text-gray-600 body-font">
  <p className="text-black text-3xl font-bold text-center justify-center">YOU MIGHT ALSO LIKE</p>
